...
public class ProductPlanDao extends BaseDao{
	...
	public boolean addPlanMapping2DB(String planId , String productId ,String gitlabProject ,String  milestoneId , String mid){
			ProductPlanEntity plan = new ProductPlanEntity(planId,productId,gitlabProject ,milestoneId , mid);
			String sql = " insert into t_product_plan ( "
					+ "uuid,"
					+ "plan_id,"
					+ "product_id,"
					+ "gitlab_project,"
